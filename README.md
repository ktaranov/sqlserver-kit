...
## Repo folders and files
 ...
 - [SSMS](/SSMS)
    - [SSMS addons](/SSMS/SSMS_Addins.md.md)
       - [SSMSBoost add-in](/SSMS/SSMS_Addins.md.md#ssmsboost 'Adds missing features and improves your productivity')
       - [SQL Code Guard](/SSMS/SSMS_Addins.md.md#sql-code-guard 'Provides fast and comprehensive static analysis for T-Sql code, shows code complexity and objects dependencies')
       - [SQL Search](/SSMS/SSMS_Addins.md.md#sql-search 'Free add-in from Red Gate that lets you quickly search for SQL across your databases')
       - [SQL Scripts Manager](/SSMS/SSMS_Addins.md.md#sql-scripts-manager 'Powerful and reliable scripts written by SQL Server experts')
       - [Supratimas](/SSMS/SSMS_Addins.md.md#supratimas 'SQL Server query execution visualizer')
       - [dbForge SQL Complete](/SSMS/SSMS_Addins.md.md#dbforge-sql-complete)
       - [SSMS Tools Pack](/SSMS/SSMS_Addins.md.md#ssms-tools-pack)
       - [SQL Pretty Printer](/SSMS/SSMS_Addins.md.md#sql-pretty-printer)
       - [SQL Sentry Plan Explorer](/SSMS/SSMS_Addins.md.md#sql-sentry-plan-explorer)
       - [TSQL Code Smells Finder](/SSMS/SSMS_Addins.md.md#tsql-code-smells-finder)
       - [SQLTreeo](/SSMS/SSMS_Addins.md.md#sqltreeo)
       - [ApexSQL Complete](/SSMS/SSMS_Addins.md.md#apexsql-complete)
       - [ApexSQL Refactor](/SSMS/SSMS_Addins.md.md#apexsql-refactor)
       - [ApexSQL Search](/SSMS/SSMS_Addins.md.md#apexsql-search)
       - [Spotlight Developer](/SSMS/SSMS_Addins.md.md#spotlight-developer)
       - [dbForge Source Control](/SSMS/SSMS_Addins.md.md#dbforge-source-control)
       - [dbForge Unit Test](/SSMS/SSMS_Addins.md.md#dbforge-unit-test)
       - [dbForge Data Pump](/SSMS/SSMS_Addins.md.md#dbforge-data-pump)
       - [dbForge Index Manager](/SSMS/SSMS_Addins.md.md#dbforge-index-manager)
       - [dbForge Object Search](/SSMS/SSMS_Addins.md.md#dbforge-object-search)
