...
## Repo folders and files
 ...
 - [SSMS](/SSMS)
    - [SSMS addons](/SSMS_addons.md)
       - [SSMSBoost add-in](/SSMS_addons.md#ssmsboost 'Adds missing features and improves your productivity')
       - [SQL Code Guard](/SSMS_addons.md#sql-code-guard 'Provides fast and comprehensive static analysis for T-Sql code, shows code complexity and objects dependencies')
       - [SQL Search](/SSMS_addons.md#sql-search 'Free add-in from Red Gate that lets you quickly search for SQL across your databases')
       - [SQL Scripts Manager](/SSMS_addons.md#sql-scripts-manager 'Powerful and reliable scripts written by SQL Server experts')
       - [Supratimas](/SSMS_addons.md#supratimas 'SQL Server query execution visualizer')
       - [dbForge SQL Complete](/SSMS_addons.md#dbforge-sql-complete)
       - [SSMS Tools Pack](/SSMS_addons.md#ssms-tools-pack)
       - [SQL Pretty Printer](/SSMS_addons.md#sql-pretty-printer)
       - [SQL Sentry Plan Explorer](/SSMS_addons.md#sql-sentry-plan-explorer)
       - [TSQL Code Smells Finder](/SSMS_addons.md#tsql-code-smells-finder)
       - [SQLTreeo](/SSMS_addons.md#sqltreeo)
       - [ApexSQL Complete](/SSMS_addons.md#apexsql-complete)
       - [ApexSQL Refactor](/SSMS_addons.md#apexsql-refactor)
       - [ApexSQL Search](/SSMS_addons.md#apexsql-search)
       - [Spotlight Developer](/SSMS_addons.md#spotlight-developer)
       - [dbForge Source Control](/SSMS_addons.md#dbforge-source-control)
       - [dbForge Unit Test](/SSMS_addons.md#dbforge-unit-test)
       - [dbForge Data Pump](/SSMS_addons.md#dbforge-data-pump)
       - [dbForge Index Manager](/SSMS_addons.md#dbforge-index-manager)
       - [dbForge Object Search](/SSMS_addons.md#dbforge-object-search)
